          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                fit: BoxFit.cover,
                image: Image.network(
                  'https://images.pexels.com/photos/12017866/pexels-photo-12017866.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
                ).image,
              ),
            ),
            child: Column(
                      ...
                      child: Column(
                        children: [
                          TabBar(
                            ...
                            unselectedLabelColor: Color(0xBF000000),
                            labelStyle:
                                FlutterFlowTheme.of(context).bodyText1.override(
                                      fontFamily: 'Source Sans Pro',
                                      fontSize: 18,
                                    ),
                            indicatorColor: Color(0xFFFF0B60),
                            tabs: [
                              Tab(
                                text: 'Posts',
                              ),
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        final usersLikedElement =
                                                                            currentUserUid;
                                                                        final usersLikedUpdate = listViewPostsRecord.usersLiked.toList().contains(usersLikedElement)
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      final usersLikedElement =
                                                                          currentUserUid;
                                                                      final usersLikedUpdate = listViewPostsRecord
                                                                              .usersLiked
                                                                              .toList()
                                                                              .contains(
                                                                                  usersLikedElement)
