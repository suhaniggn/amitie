          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                fit: BoxFit.cover,
                image: Image.network(
                  'https://images.pexels.com/photos/7789953/pexels-photo-7789953.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
                ).image,
              ),
            ),
            child: Column(
                    ...
                    child: StreamBuilder<List<PostsRecord>>(
                      stream: queryPostsRecord(
                        queryBuilder: (postsRecord) =>
                            postsRecord.orderBy('time_stamp', descending: true),
                      ),
